...
#ifndef L2_LOGISTIC_LOSS_PROX_H
#define L2_LOGISTIC_LOSS_PROX_H
...
class L2LogisticLossProx : public ContinuousFunctions {
protected:
...
Vector& x0;
public:
L2LogisticLossProx(int numFeatures, std::vector<Feature>& features, Vector& y, Vector& x0, double lambda);
L2LogisticLossProx(const L2LogisticLossProx& c);         // copy constructor
