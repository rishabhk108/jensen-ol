...
Vector gd_maxDiff(const ContinuousFunctions& c, const Vector& x0, double& maxDiff, const double alpha = 0.1,
          const int maxEval = 1000, const double TOL = 1e-3, const int verbosity = 0);
